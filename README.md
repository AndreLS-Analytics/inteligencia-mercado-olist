...
Top 5 Estados Mais Rápidos na Entrega (Eficiência): Mapeamento das regiões de alta performance logística (lideradas por Santa Catarina - SC, com 14,5 dias médios), operando de benchmark para a operação.
...
Para analisar os scripts de extração e consultas: Consulte o arquivoanalise_inicial_olist.sql
Para interagir com os filtros e fórmulas DAX: Faça o download do arquivo .pbixatualizado.
