...
![Painel de Desempenho Comercial](dashboard_performance_comercial.jpg)

### 2. Dashboard de Performance Logística
![Dashboard de Performance Logística](Relatorio_Performance_Logistica.jpg)
...
* **Concentração Geográfica:** Análise regional revelou que São Paulo (SP) liderou as receitas de forma isolada, acompanhadas por Rio de Janeiro (RJ) e Minas Gerais (MG).
